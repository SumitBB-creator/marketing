...
export class BrandingService {
     ...
     */
    async updateBrandingConfig(data: Partial<Omit<BrandingConfig, 'id' | 'updated_at' | 'updated_by'>>, userId: string): Promise<BrandingConfig> {
     ...
     */
    async resetBrandingConfig(userId: string): Promise<BrandingConfig> {
